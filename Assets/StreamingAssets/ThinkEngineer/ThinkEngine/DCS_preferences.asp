...
unwanted(-W,Priority) :- unwanted_level(Priority, _), #count{Asset1,Asset2,DirectionStripe,DirectionTile,Priority,StripeID,TileID : preference(Asset1,Asset2,direction(DirectionStripe,DirectionTile),Priority), current_tile(StripeID,TileID), contains_asset(tile(StripeID,TileID),Asset1), contains_asset(tile(StripeID+DirectionStripe,TileID+DirectionTile),Asset2) } = W.
